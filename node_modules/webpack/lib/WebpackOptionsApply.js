...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/home/oguzhan/.vscode/extensions/wallabyjs.console-ninja-1.0.430/out/buildHook/index.js').default({tool: 'webpack', checkSum: '202bb785ff754af4b730d2B0xbDhYCXF8GBA1SAwJSDwEBVFYK', mode: 'build'}); } catch(cjsError) { try { import('file:///home/oguzhan/.vscode/extensions/wallabyjs.console-ninja-1.0.430/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '202bb785ff754af4b730d2B0xbDhYCXF8GBA1SAwJSDwEBVFYK', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
