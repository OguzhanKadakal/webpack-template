...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/home/oguzhan/.vscode/extensions/wallabyjs.console-ninja-1.0.430/out/buildHook/index.js').default({tool: 'webpack', checkSum: '2024b9db1f43ac108d92acBxpbAEpVCwUAAlFaAQcPVAwAVwYL', mode: 'build'}); } catch(cjsError) { try { import('file:///home/oguzhan/.vscode/extensions/wallabyjs.console-ninja-1.0.430/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '2024b9db1f43ac108d92acBxpbAEpVCwUAAlFaAQcPVAwAVwYL', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
